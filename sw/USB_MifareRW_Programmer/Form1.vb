...
Public Class Form1
    ...
    Public Shared Function SetupDiGetDeviceRegistryProperty(
        ...
        ByVal dwProperty As UInteger,
        ByRef PropertyRegDataType As UInteger,
    ...
    Public Shared Function RegisterDeviceNotification(
    ...
    Private Function pisiostalo(ByVal tip As String) As String
        Try
            ...
            If CheckBox1.Checked Then OUTBuffer(21) = Encoding.ASCII.GetBytes("a")(0)
            If CheckBox2.Checked Then OUTBuffer(22) = Encoding.ASCII.GetBytes("b")(0)
            If CheckBox3.Checked Then OUTBuffer(23) = Encoding.ASCII.GetBytes("c")(0)
            If CheckBox4.Checked Then OUTBuffer(24) = Encoding.ASCII.GetBytes("d")(0)
            If CheckBox12.Checked Then OUTBuffer(25) = Encoding.ASCII.GetBytes("e")(0)
            If CheckBox13.Checked Then OUTBuffer(26) = Encoding.ASCII.GetBytes("f")(0)
            'dani
            If CheckBox5.Checked Then OUTBuffer(27) = Encoding.ASCII.GetBytes("m")(0)
            If CheckBox6.Checked Then OUTBuffer(28) = Encoding.ASCII.GetBytes("t")(0)
            If CheckBox11.Checked Then OUTBuffer(29) = Encoding.ASCII.GetBytes("w")(0)
            If CheckBox7.Checked Then OUTBuffer(30) = Encoding.ASCII.GetBytes("h")(0)
            If CheckBox8.Checked Then OUTBuffer(31) = Encoding.ASCII.GetBytes("f")(0)
            If CheckBox9.Checked Then OUTBuffer(32) = Encoding.ASCII.GetBytes("s")(0)
            If CheckBox10.Checked Then OUTBuffer(33) = Encoding.ASCII.GetBytes("n")(0)

            'Dim tt As String = 2159
            'Dim ids As Byte()
            'ids = Encoding.ASCII.GetBytes(tt)
            'idslike 
            Dim idslike As String = "0000" & TextBox5.Text 'system ID = 12345 for example'
            OUTBuffer(34) = Encoding.ASCII.GetBytes(idslike.Substring(idslike.Length - 4, 1))(0) '= 1 from sys ID'
            OUTBuffer(35) = Encoding.ASCII.GetBytes(idslike.Substring(idslike.Length - 3, 1))(0) '= 2 from sys ID'
            OUTBuffer(36) = Encoding.ASCII.GetBytes(idslike.Substring(idslike.Length - 2, 1))(0) '= 3 from sys ID'
            OUTBuffer(37) = Encoding.ASCII.GetBytes(idslike.Substring(idslike.Length - 1, 1))(0) '= 4 from sys ID'

            'duzina boravka
            Dim dbor As String = "00" & NumericUpDown3.Value
            OUTBuffer(38) = Encoding.ASCII.GetBytes(dbor.Substring(dbor.Length - 2, 1))(0) '= 3 from sys ID'
            OUTBuffer(39) = Encoding.ASCII.GetBytes(dbor.Substring(dbor.Length - 1, 1))(0)
            ...
            'grupa kor
            Dim gk As String = "00" & NumericUpDown4.Value
            OUTBuffer(48) = Encoding.ASCII.GetBytes(gk.Substring(gk.Length - 2, 1))(0) '= 3 from sys ID'
            OUTBuffer(49) = Encoding.ASCII.GetBytes(gk.Substring(gk.Length - 1, 1))(0)

            'koristeno vrijeme
            Dim koristeno_vrijeme As String = "0000" & TextBox7.Text
            OUTBuffer(50) = Encoding.ASCII.GetBytes(koristeno_vrijeme.Substring(koristeno_vrijeme.Length - 4, 1))(0)
            OUTBuffer(51) = Encoding.ASCII.GetBytes(koristeno_vrijeme.Substring(koristeno_vrijeme.Length - 3, 1))(0)
            OUTBuffer(52) = Encoding.ASCII.GetBytes(koristeno_vrijeme.Substring(koristeno_vrijeme.Length - 2, 1))(0)
            OUTBuffer(53) = Encoding.ASCII.GetBytes(koristeno_vrijeme.Substring(koristeno_vrijeme.Length - 1, 1))(0)
    ...
    Private Sub PROCITAJ(ByVal T As String)
        ...
        If OUTBuffer(1) = &H43 Then     'chek is C first in input string

            Dim lenght As Int16 = T.Length  'get number of requests
            Dim increment As Int16 = 0
            Dim requests As [Byte]() = New Byte(6) {}

            While lenght > 1    'copy request string to query buffer
                requests(increment) = Encoding.ASCII.GetBytes(T)(lenght - 1)
                lenght -= 1
                increment += 1
            End While

            increment = 0
            lenght = T.Length - 1   'set loop cycles for all requested readings

            While increment < lenght

                OUTBuffer(2) = requests(increment)  'send requests one by one 
                ...
                If WriteFile(WriteHandleToUSBDevice, OUTBuffer, 65, BytesWritten, IntPtr.Zero) Then
                    ...
                    If ReadFileManagedBuffer(ReadHandleToUSBDevice, INBuffer, 65, BytesRead, IntPtr.Zero) Then
                        ...
                        Dim card_expiry_date As String
                        Dim card_expiry_time As String
                        Dim number_of_users As String
                        Dim card_usage_type As String
                        Dim system_id As String
                        Dim tag_type As String
                        Dim user_group As String
                        Dim user_image_id As String
                        Dim prepaid_time As String
                        Dim entry_enabled_days As String = ""
                        Dim entry_time As String
                        Dim exit_time As String
                        Dim user_last_entry_date As String
                        Dim user_last_entry_time As String
                        Dim user_last_exit_date As String
                        Dim user_last_exit_time As String
                        Dim used_time As String

                        'card id	
                        Dim cid() As Byte = New Byte() {response(2), response(3), response(4), response(5), response(6)}
                        card_id = BitConverter.ToUInt32(cid, 0)

                        'card expiry date & time
                        Dim cex_day() As Byte = New Byte() {((response(7) >> 4) + 48), ((response(7) And &HF) + 48)}
                        Dim cex_month() As Byte = New Byte() {((response(8) >> 4) + 48), ((response(8) And &HF) + 48)}
                        Dim cex_year() As Byte = New Byte() {((response(9) >> 4) + 48), ((response(9) And &HF) + 48)}
                        Dim cex_hour() As Byte = New Byte() {((response(10) >> 4) + 48), ((response(10) And &HF) + 48)}
                        Dim cex_minute() As Byte = New Byte() {((response(11) >> 4) + 48), ((response(11) And &HF) + 48)}
                        card_expiry_date = Encoding.UTF8.GetString(cex_day) & "." & Encoding.UTF8.GetString(cex_month) & ".20" & Encoding.UTF8.GetString(cex_year)
                        card_expiry_time = Encoding.UTF8.GetString(cex_hour) & ":" & Encoding.UTF8.GetString(cex_minute)

                        'number of users
                        Dim num_users() As Byte = New Byte() {((response(12) >> 4) + 48), ((response(12) And &HF) + 48)}
                        number_of_users = Encoding.UTF8.GetString(num_users)

                        'card type: one time, prepaid
                        card_usage_type = Encoding.UTF8.GetString(New Byte() {response(13)})

                        'system id
                        Dim sid As Int32 = response(14)
                        sid = sid << 8
                        sid = sid + response(15)
                        system_id = Convert.ToString(sid)

                        'rfid tag type: wrist, card, keyring
                        tag_type = Encoding.UTF8.GetString(New Byte() {response(16)})

                        'user grop  1...99
                        user_group = Convert.ToString(response(17))

                        'user image id: 1...9999    = 1.bmp .... 9999.bmp  on uSD card
                        Dim img_id As Int32 = response(18)
                        img_id = img_id << 8
                        img_id = img_id + response(19)
                        user_image_id = Convert.ToString(img_id)

                        'prepaid time in response in minutes, form select is in hours
                        Dim pd_time As Int32 = response(20)
                        pd_time = pd_time << 8
                        pd_time = pd_time + response(21)
                        prepaid_time = Convert.ToString(pd_time)

                        'entry enabled days
                        If (response(22) And &H80) Then entry_enabled_days = entry_enabled_days & "Pn "
                        If (response(22) And &H40) Then entry_enabled_days = entry_enabled_days & "Ut "
                        If (response(22) And &H20) Then entry_enabled_days = entry_enabled_days & "Sr "
                        If (response(22) And &H10) Then entry_enabled_days = entry_enabled_days & "Ct "
                        If (response(22) And &H8) Then entry_enabled_days = entry_enabled_days & "Pt "
                        If (response(22) And &H4) Then entry_enabled_days = entry_enabled_days & "Su "
                        If (response(22) And &H2) Then entry_enabled_days = entry_enabled_days & "Ne "

                        'entry enabled time
                        Dim ent_hour() As Byte = New Byte() {((response(23) >> 4) + 48), ((response(23) And &HF) + 48)}
                        Dim ent_minute() As Byte = New Byte() {((response(24) >> 4) + 48), ((response(24) And &HF) + 48)}
                        entry_time = Encoding.UTF8.GetString(ent_hour) & ":" & Encoding.UTF8.GetString(ent_minute)

                        'exit enabled time
                        Dim ext_hour() As Byte = New Byte() {((response(25) >> 4) + 48), ((response(25) And &HF) + 48)}
                        Dim ext_minute() As Byte = New Byte() {((response(26) >> 4) + 48), ((response(26) And &HF) + 48)}
                        exit_time = Encoding.UTF8.GetString(ext_hour) & ":" & Encoding.UTF8.GetString(ext_minute)

                        'user last entry date & time
                        Dim len_day() As Byte = New Byte() {((response(39) >> 4) + 48), ((response(39) And &HF) + 48)}
                        Dim len_month() As Byte = New Byte() {((response(40) >> 4) + 48), ((response(40) And &HF) + 48)}
                        Dim len_year() As Byte = New Byte() {((response(41) >> 4) + 48), ((response(41) And &HF) + 48)}
                        Dim len_hour() As Byte = New Byte() {((response(42) >> 4) + 48), ((response(42) And &HF) + 48)}
                        Dim len_minute() As Byte = New Byte() {((response(43) >> 4) + 48), ((response(43) And &HF) + 48)}
                        user_last_entry_date = Encoding.UTF8.GetString(len_day) & "." & Encoding.UTF8.GetString(len_month) & ".20" & Encoding.UTF8.GetString(len_year)
                        user_last_entry_time = Encoding.UTF8.GetString(len_hour) & ":" & Encoding.UTF8.GetString(len_minute)

                        'user last exit date & time
                        Dim lex_day() As Byte = New Byte() {((response(44) >> 4) + 48), ((response(44) And &HF) + 48)}
                        Dim lex_month() As Byte = New Byte() {((response(45) >> 4) + 48), ((response(45) And &HF) + 48)}
                        Dim lex_year() As Byte = New Byte() {((response(46) >> 4) + 48), ((response(46) And &HF) + 48)}
                        Dim lex_hour() As Byte = New Byte() {((response(47) >> 4) + 48), ((response(47) And &HF) + 48)}
                        Dim lex_minute() As Byte = New Byte() {((response(48) >> 4) + 48), ((response(48) And &HF) + 48)}
                        user_last_exit_date = Encoding.UTF8.GetString(lex_day) & "." & Encoding.UTF8.GetString(lex_month) & ".20" & Encoding.UTF8.GetString(lex_year)
                        user_last_exit_time = Encoding.UTF8.GetString(lex_hour) & ":" & Encoding.UTF8.GetString(lex_minute)

                        'sofar used time in minutes
                        Dim us_time As Int32 = response(49)
                        us_time = us_time << 8
                        us_time = us_time + response(50)
                        used_time = Convert.ToString(us_time)

                        'form control update
                        TextBox7.Text = used_time

                    End If
                End If

                increment += 1  'select next request
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        If CheckBox1.Checked Then pisiostalo("P")
        If CheckBox2.Checked Then pisiostalo("K")
        If CheckBox3.Checked Then pisiostalo("R")
        If CheckBox4.Checked Then pisiostalo("H")
    End Sub

    Private Sub Button1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim read_call As String = "C"
        If CheckBox1.Checked Then read_call = read_call & "a"
        If CheckBox2.Checked Then read_call = read_call & "b"
        If CheckBox3.Checked Then read_call = read_call & "c"
        If CheckBox4.Checked Then read_call = read_call & "d"
        If CheckBox12.Checked Then read_call = read_call & "e"
        If CheckBox13.Checked Then read_call = read_call & "g"
        PROCITAJ(read_call)
    End Sub
    ...
    Private Sub CheckBox14_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox14.CheckedChanged
        If CheckBox14.Checked Then
            Process.Start("USB_MifareRW_Bootloader.exe")
            PROCITAJ("U")
        End If
    End Sub
