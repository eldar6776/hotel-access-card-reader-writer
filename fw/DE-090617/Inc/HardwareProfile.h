/********************************************************************
 ...
 (the "Company") for its PICÄŹĹĽËť Microcontroller is intended and
...
//#define LED_RED_DOUT            LATAbits.LATA6
...
#elif defined(__18F25K50)
/** LED ************************************************************/
#define LED_RED_DOUT                (LATAbits.LATA4)
#define LED_BLUE_DOUT               (LATAbits.LATA7)
